...
export const TrailerLoadingCapacity = [
    ...
    },
    {
        ...
        description: "Trailer that connects to a ball hitch in the bed of a pickup truck, providing more stability.",
    ...
    },
    {
        ...
        description: "Enclosed trailer with temperature control for perishable goods.",
    ...
    },
    {
        id: 4,
        title: "Dump Trailer",
        description: "Trailer with a hydraulic lift used for transporting loose materials like sand, gravel, or demolition waste.",
    ...
    },
    {
        ...
        description: "Trailer with a low deck height used for transporting heavy equipment.",
        weightCapacity: "Approximately 40,000 to 80,000 pounds (depending on the number of axles)",
    ...
    },
    {
        ...
        weightCapacity: "Approximately 50,000 pounds (depending on the type of liquid or gas and trailer specifications)",
    ...
    },
    {
        ...
        description: "Trailer with a lower deck height, allowing for taller loads than a flatbed.",
    ...
    },
    {
        ...
        weightCapacity: "Approximately 40,000 pounds (typically can carry 7-9 cars)",
        standardLengths: ["45 feet", "48 feet", "53 feet", "80 feet (double-deck trailers)"],
        isWeightSelected: false
    },
    {
        id: 9,
        ...
        weightCapacity: "Approximately 20,000 to 30,000 pounds (depending on the type and number of animals)",
        standardLengths: ["20 feet", "24 feet", "28 feet", "32 feet", "40 feet", "50 feet", "53 feet"],
        isWeightSelected: false
    }
];
    ...
    },
    {
        ...
        model: [
            ...
            },
            {
                ...
                title: "Ford F-550",
                isModelSelected: false,
                capacity: "Approximately 6,000 to 12,000 pounds (depending on configuration)",
            },
            {
                id: 19,
                title: "Ford F-650",
                isModelSelected: false,
                capacity: "Approximately 8,000 to 14,000 pounds (depending on configuration)",
            },
            {
                id: 20,
                title: "Ford F-750",
                isModelSelected: false,
                capacity: "Approximately 12,000 to 20,000 pounds (depending on configuration)",
            },
            {
                id: 21,
            ...
            },
            {
                ...
                isModelSelected: false,
                capacity: "Approximately 9,000 to 12,000 pounds (depending on configuration)",
            },
            {
                id: 23,
                title: "Chevrolet Silverado 6500",
                isModelSelected: false,
                capacity: "Approximately 12,000 to 14,000 pounds (depending on configuration)",
            },
            {
                id: 24,
                title: "Ram 4500",
            ...
            },
            {
                ...
                title: "Ram 5500",
                isModelSelected: false,
                capacity: "Approximately 8,000 to 12,000 pounds (depending on configuration)",
            }
        ]
    }
];

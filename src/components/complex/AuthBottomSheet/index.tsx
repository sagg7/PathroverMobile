...
import { PFColors, PFFontSize, PFFonts, WP, isIOS } from '../../../shared/exporter';
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.modalContent}>
                    ...
                    <AppButton title={emailTitle} icon={svgIcon.Email} handleClick={handleClickEmail} />
                    <AppButton title={phoneTitle} icon={svgIcon.Phone} buttonStyle={styles.phoneBtnStyles} handleClick={handleClickPhone} />

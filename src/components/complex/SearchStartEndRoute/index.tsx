...
const SearchStartEndRoute = ({setRouteData, title}: any) => {
  ...
  const [endPointAddress, setEndPointAddress] = useState<any>(null);
  ...
  const onPressApply = () => {
    ...
    const end = {
      coords: [
        Number(locations?.dropoffLongitude),
        Number(locations?.dropoffLatitude),
      ],
    };
    const start = {
      coords: [
        Number(locations?.pickupLongitude),
        Number(locations?.pickupLatitude),
      ],
    };
    dispatch(setCreateRouteData({start: start, end: end}));
    ...
    <View>
      ...
      {isAddressSelected ? (
        <View style={styles.locationBoxContainer}>
          ...
          <View>
            <LocationBox
              title={title?.start ? title?.start : 'Your Start Location'}
              onPress={onPressAddressPickup}
            />
            <LocationBox
              title={title?.end ? title?.end : 'Your End Location'}
              onPress={() =>
                navigation.navigate(Routes.ChooseStartPoint, {
                  endPointAddress,
                  setEndPointAddress,
                  isStartPoint: false,
                })

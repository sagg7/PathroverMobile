...
import { DriverProfileMenu, UNEXPECTED_ERROR, USER_PROFILE, showAlert } from '../../../../shared/utils/constant';
...
const Settings = ({ navigation }) => {
    ...
    const settingOption = ({ item }) => {
        return (
            <TouchableOpacity style={styles.listConatainer} onPress={() => handleNavigation(item.id)} key={item.id}>
